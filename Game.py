...
#grabbing choice of mark for the player
def player_input():
    marker = ' '
...
#place the marker on chosen position in grid
def place_marker(board, marker, position):
    board[position] = marker

#checking the win conditions
#mark should be placed horizontally, vertically or diagonally same
...
#if player want to replay the game
def replay():
